...
//unltd 추가 시작
} else if( $t = PsysPay::getOrderUrl($_POST['paymethod'], $od_id, TB_MSHOP_URL) ) {
	goto_url($t);
//unltd 추가 끝
	...
	if($default['de_pg_service'] == 'kcp')
		...
		goto_url(TB_MSHOP_URL.'/orderallat.php?od_id='.$od_id);
    else if($default['de_pg_service'] == 'kiwoom')
        goto_url(TB_MSHOP_URL.'/orderkiwoom.php?od_id='.$od_id);
}
?>