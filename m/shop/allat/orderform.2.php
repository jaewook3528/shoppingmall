...
<!-- 에스크로 적용 대상 결제건에 대해서만 적용됨 -->
<input type="hidden" name="allat_abankes_yn" value="<?php //echo ($default['de_escrow_use']?'Y':'N'); ?>">
...
<!-- 선택결제수단 -->
<input type="hidden" name="allat_select_pay_type" value="">

<!-- 간편결제수단 -->
<input type="hidden" name="allat_spay_type" value="">