...
<div class="tbl_frm01">
    ...
    <tr>
        <th scope="row">피시스 Client ID</th>
        <td>
            <input type="text" name="de_psys_appid" value="<?php echo $default['de_psys_appid']; ?>" class="frm_input" size="50">
        </td>
    </tr>
    <tr>
        <th scope="row">피시스 Client Secret</th>
        <td><input type="text" name="de_psys_secret" value="<?php echo $default['de_psys_secret']; ?>" class="frm_input" size="50"></td>
    </tr>
    <tr>
        <th scope="row">페이투페이 Client ID</th>
        <td>
            <input type="text" name="de_pay2pay_appid" value="<?php echo $default['de_pay2pay_appid']; ?>" class="frm_input" size="50">
        </td>
    </tr>
    <tr>
        <th scope="row">페이투페이 Client Secret</th>
        <td><input type="text" name="de_pay2pay_secret" value="<?php echo $default['de_pay2pay_secret']; ?>" class="frm_input" size="50"></td>
    </tr>
	</tbody>
	</table>
</div>
