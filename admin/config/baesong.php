            ...
            <div class="tbl_frm02">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="delivery_price2" value="<?php echo number_format($config['delivery_price2']); ?>" class="frm_input" size="10" onkeyup="addComma(this);"> 원의 배송비를 부과하며 단! 단일 상품금액의 합이
                            <input type="text" name="delivery_minimum" value="<?php echo number_format($config["delivery_minimum"]); ?>" class="frm_input" size="10" onkeyup="addComma(this);"> 원 이상이면 해당 상품은 무료배송 처리됩니다
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        <td>
            <div class="tbl_frm02">
                <table>
                    ...
                    <tr>
                        <th scope="row">
                            <input type="radio" name="delivery_totmethod" value="0" id="delivery_totmethod0" <?php echo get_checked($config['delivery_totmethod'], "0"); ?>>
                    ...
                    <tr>
                        <th scope="row">
                            <input type="radio" name="delivery_totmethod" value="1" id="delivery_totmethod1" <?php echo get_checked($config['delivery_totmethod'], "1"); ?>>
                            <label for="delivery_totmethod1">주문금액별 무료배송</label>
                        </th>
                        <td>
                            동일 공급사의 총 주문금액의 합이 <input type="text" name="delivery_totminimum" value="<?php echo number_format($config["delivery_totminimum"]); ?>" class="frm_input" size="10" onkeyup="addComma(this);"> 원 이상이면 해당 공급사의 배송비는 무료배송 처리됩니다
                        </td>
                    </tr>
                    </tbody>
                </table>
