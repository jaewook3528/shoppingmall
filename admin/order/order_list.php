...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			...
			<?php if($member['id'] == 'admin') { // unltd?>
			<?php echo radio_checked('od_settle_case', $od_settle_case, '연구비카드', '연구비카드'); ?>
			<?php echo radio_checked('od_settle_case', $od_settle_case, '장기무이자', '장기무이자'); ?>
			<?php } ?>
		</td>
	</tr>
	<tr>
...
<div class="tbl_head01">
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="<?php echo $rowspan; ?>"><?php echo $sodr['disp_paytype']; ?><?php echo ($row2['od_card_nm'] ? ' ('.$row2['od_card_nm'].')' : ''); ?><?php echo ($row2['od_sell_mm'] ? ', ('.$row2['od_sell_mm'].'개월)' : ''); ?></td>
