...
<a href="./design.php?code=contentdefaultform" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_upd = "<a href='./design.php?code=contentdefaultform&w=u&co_id=$co_id$qstr&page=$page' class=\"btn_small\">수정</a>";
		$page_url = "/bbs/content.php?co_id={$co_id}&page_id={$row['page_id']}&pt_id={$row['pt_id']}";
	...
	<tr class="<?php echo $bg; ?>">
		...
		<td><input type="text" name="co_subject[<?php echo $i; ?>]" value="<?=$row['co_subject']; ?>" class="frm_input"></td>
