...
<div class="vi_info">
	<div class="vi_img_bx" style="width:<?php echo $default['de_item_medium_wpx']; ?>px">
		...
		<div class="bimg">
			<?php
			if($gs['simg2'])
				echo get_it_image($index_no, $gs['simg2'], $default['de_item_medium_wpx'], $default['de_item_medium_hpx'], "id='big'");
			else
				echo "<img src='".TB_IMG_URL."/sub/noimage_q2.gif' width='".$default['de_item_medium_wpx']."' height='".$default['de_item_medium_hpx']."' id='big'>";
			?>
		</div>
		<div class="simg_li">
			<ul>
	...
	<div class="vi_txt_bx">
		<h2 class="tit">
			<?php echo $gs['gname'].PsysPay::getLongUseStr($gs); ?>
