...
require_once(TB_SHOP_PATH.'/pay2pay_pay/orderform.1.php');
?>
...
require_once(TB_SHOP_PATH.'/pay2pay_pay/orderform.2.php');
?>
...
function forderform_check(f)
{
    ...
    if( typeof pay2pay_pay_submit === "function" ) {
        pay2pay_pay_submit(f);
        return ;
    }
