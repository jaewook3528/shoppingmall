			...
			<div id="gnb">
				<div id="gnb_inner">
					<div class="all_cate">
						...
						<div class="con_bx" style="height: 200px;">
							<ul>
							<?php
							$mod = 5;
					...
					<div class="gnb_li">
						<ul style="text-align: left;">
							<!--<li><a href="<?php /*echo TB_SHOP_URL; */?>/listtype.php?type=2">베스트셀러</a></li>-->
							<li style=" padding-left: 38px; "><a href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=3">영상 / TV Best</a></li>
							<li><a href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=4">생활가전 Best</a></li>
							<li><a href="<?php echo TB_SHOP_URL; ?>/listtype.php?type=5">주방가전 Best</a></li>
