...
<form name="faqform" method="post" action="<?=TB_ADMIN_URL?>/help/help_faq_form_update.php" onsubmit="return faqform_submit(this);">
    ...
    <input type="hidden" name="pt_id" value="<?=$_SESSION['ss_mb_id']?>">
    ...
    <div class="btn_confirm">
        ...
        <a href="./page.php?code=partner_faq_list<?php echo $qstr; ?>&page=<?php echo $page; ?>" class="btn_large bx-white">목록</a>
    </div>
</form>
</div>
...
<script>
    function faqform_submit(f) {
        ...
        f.action = "<?=TB_ADMIN_URL?>/help/help_faq_form_update.php";
        return true;
    }
</script>
