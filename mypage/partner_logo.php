...
include_once(TB_LIB_PATH."/psys/PsysUtil.php");
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
            ...
            <? PsysUtil::getLogoTypeHtml($lg, 'basic_logo_type', 'basic_logo_text'); ?>
	...
	<tr>
		...
		<td>
            ...
            <? PsysUtil::getLogoTypeHtml($lg, 'mobile_logo_type', 'mobile_logo_text'); ?>
