...
// 테이블의 전체 레코드수만 얻음
$total_count = get_qa_total($sql_common,$sql_search);
...
<form name="fqalist" id="fqalist" method="post" action="<?=TB_ADMIN_URL?>/help/help_qa_delete.php" onsubmit="return fqalist_submit(this);">
    ...
    <div class="tbl_head01">
        <table>
            ...
            for($i=0; $row=sql_fetch_array($result); $i++) {
                $s_upd = "<a href=\"./page.php?code=partner_qa_form&w=u&index_no={$row['index_no']}$qstr&page=$page\" class=\"btn_small\">수정</a>";
