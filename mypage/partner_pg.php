...
if(!get_session('admin_ss_mb_id'))
	alert('최고관리자만 접근하실 수 있습니다.');
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td class="td_label">
			...
			<!-- psys 결제 추가 S-->
<?
if ($member['use_pg_rnd']) {
    ?>
			<input type="checkbox" name="de_psys_rnd_use" value="1" id="de_psys_rnd_use"<?php echo get_checked($partner['de_psys_rnd_use'], "1"); ?>>
			<label for="de_psys_rnd_use">연구비카드</label>
    <?
}
if ($member['use_pg_long']) {
    ?>
			<input type="checkbox" name="de_psys_long_use" value="1" id="de_psys_long_use"<?php echo get_checked($partner['de_psys_long_use'], "1"); ?>>
...
?>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="de_card_installment" value="<?php echo $partner['de_card_installment']; ?>" id="de_card_installment" class="frm_input" size="10" maxlength="50">
            <?php echo help('[키움페이만 가능]최대 가능한 할부개월 값을 입력해 주십시오. 0 : 제한없음.<br>적용되는 PG사: 키움페이'); ?>
        </td>
    </tr>
	</tbody>
	</table>
...
<div class="pg_info_fld kcp_info_fld">
	...
	<div class="tbl_frm01">
		...
		<tr>
			...
			<td>
				<?php echo $admin_shop_url; ?>/settle_kcp_common.php
...
<div class="pg_info_fld inicis_info_fld">
	...
	<div class="tbl_frm01">
		...
		<tr>
			<th scope="row">가상계좌 입금통보 URL</th>
			<td>
				<?php echo $admin_shop_url; ?>/settle_inicis_common.php
...
<div class="pg_info_fld allat_info_fld">
	...
	<div class="tbl_frm01">
		...
		<tr>
			<th scope="row">가상계좌 입금통보 URL</th>
			<td>
				<?php echo $admin_shop_url; ?>/settle_allat_common.php
			</td>
		</tr>
		</tbody>
		</table>
    ...
    <div class="tbl_frm01">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="de_kiwoom_mid" value="<?php echo $partner['de_kiwoom_mid']; ?>" id="de_kiwoom_mid" class="frm_input" size="10">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="de_kiwoom_crosskey" value="<?php echo $partner['de_kiwoom_crosskey']; ?>" id="de_kiwoom_crosskey" class="frm_input" size="40" maxlength="50">
...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
            ...
            <? PsysPay::getSelServiceHtml('de_psys_rnd_service', $partner) ?>

            &nbsp;

            <input type="text" name="de_psys_rnd_mid" value="<?php echo $partner['de_psys_rnd_mid']; ?>" class="frm_input" size="15" placeholder="상점 아이디">
            <input type="text" name="de_psys_rnd_crosskey" value="<?php echo $partner['de_psys_rnd_crosskey']; ?>" class="frm_input" size="15" placeholder="크로스키">
		</td>
	</tr>
	<tr>
		...
		<td>
            ...
            <? PsysPay::getSelServiceHtml('de_psys_long_service', $partner) ?>

            &nbsp;

            <input type="text" name="de_psys_long_mid" value="<?php echo $partner['de_psys_long_mid']; ?>" class="frm_input" size="15" placeholder="상점 아이디">
            <input type="text" name="de_psys_long_crosskey" value="<?php echo $partner['de_psys_long_crosskey']; ?>" class="frm_input" size="15" placeholder="크로스키">
		</td>
	</tr>
	</tbody>
	</table>
