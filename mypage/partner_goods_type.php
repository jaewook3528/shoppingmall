...
$sql_common = " from shop_goods a left join shop_goods_cate c on (a.index_no=c.gs_id) left join {$target_table} d on c.gcate=d.catecode ";
$sql_search = " where (a.use_aff='0' or (a.use_aff='1' and a.mb_id='$mb_id')) and a.shop_state='0' and d.u_hide='0' and d.p_hide='0' ";
...
<div class="tbl_head01">
	...
	<tr>
		...
		<th scope="col">상품명</th>
		<th scope="col" class="th_bg lh2">쇼핑<br>특가</th>
		<th scope="col" class="th_bg lh2">베스트<br>셀러</th>
		<th scope="col" class="th_bg lh2">신규<br>상품</th>
		<th scope="col" class="th_bg lh2">인기<br>상품</th>
		<th scope="col" class="th_bg lh2">추천<br>상품</th>
		<th scope="col">진열</th>
		<th scope="col">재고</th>
		<th scope="col">판매가</th>
	</tr>
