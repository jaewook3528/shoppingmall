...
$srcfile = TB_DATA_PATH.'/category/'.$member['id'];
...
if($_POST['mod_type'] == 'u') {
	...
	goto_url(TB_MYPAGE_URL."/partner_category_mod.php?index_no=$ca_no");
}

$ca = sql_fetch("select * from {$target_table} where index_no='$ca_no'");
?>

<form name="fcgyform" method="post" action="./partner_category_mod.php" enctype="MULTIPART/FORM-DATA">
