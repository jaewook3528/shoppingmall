...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
            ...
            case 'Pay2pay':
                $this->oauth_version = '2.0';
                $this->dialog_url = $this->server_url.'/authorize.php?client_id={CLIENT_ID}&response_type=code&redirect_uri={REDIRECT_URI}&state={STATE}';
                $this->access_token_url = $this->server_url.'/token.php';
                break;
