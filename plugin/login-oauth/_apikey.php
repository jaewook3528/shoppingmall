...
// PSYS 설정
$psys_ClientID = $default['de_psys_appid'];
$psys_ClientSecret = $default['de_psys_secret'];

// Pay2Pay 설정
$pay2pay_ClientID = $default['de_pay2pay_appid'];
$pay2pay_ClientSecret = $default['de_pay2pay_secret'];
