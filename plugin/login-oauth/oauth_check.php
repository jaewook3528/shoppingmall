...
if($mb['id']) { // 가입된 회원이면
	...
	$value['gender']	    = $mb_gender==''?'M':$mb_gender; //성별
	...
	$value['cellphone']	    = $mb_cellphone; //핸드폰
	$value['birth_year']	= $mb_birth_year; //생년월일
	$value['birth_month']	= $mb_birth_month; //생년월일
	$value['birth_day']	    = $mb_birth_day; //생년월일
